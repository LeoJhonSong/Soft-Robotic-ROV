...
#define SEND_FORWARD                1, 0,  100,    0,    0,    0
#define SEND_BACKWARD               1, 0, -100,    0,    0,    0
#define SEND_LEFT                   1, 0,    0,  100,    0,    0
#define SEND_RIGHT                  1, 0,    0, -100,    0,    0
#define SEND_TURN_LEFT              1, 0,    0,    0,  100,    0
#define SEND_TURN_RIGHT             1, 0,    0,    0, -100,    0
#define SEND_UP                     1, 0,    0,    0,    0,   99
#define SEND_DOWN                   1, 0,    0,    0,    0, -100
#define SEND_HALF_FORWARD           1, 0,   50,    0,    0,    0
#define SEND_HALF_BACKWARD          1, 0,  -50,    0,    0,    0
#define SEND_HALF_LEFT              1, 0,    0,   50,    0,    0
#define SEND_HALF_RIGHT             1, 0,    0,  -50,    0,    0
#define SEND_HALF_TURN_LEFT         1, 0,    0,    0,   50,    0
#define SEND_HALF_TURN_RIGHT        1, 0,    0,    0,  -50,    0
...
#define SEND_ADJUST_BACKWARD        1, 0,  -25,    0,    0,    0
